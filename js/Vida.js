function Vida(mundo, ancho, alto, sprite, posX, posY){
...
Vida.prototype= new Objeto;

Vida.prototype.mover= function(delta){	
	//no se mueve
	
}

Vida.prototype.colision= function(){ //colision contra el jugador
...
Vida.prototype.dibujar=function(contexto){
